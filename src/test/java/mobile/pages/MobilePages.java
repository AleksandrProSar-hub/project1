...
public class MobilePages {
    ...
    private final String listName1 = "—писок 1";
    private final String listName2 = "—писок 2";

    private final String listDescription1 = "ќписание 1";
    private final String listDescription2 = "ќписание 2";

    private final String nameArticleSaveUserList = "Java";

    private final String descriptionArticleSaveUserList = "€зык программировани€";
    ...
    public void transitionSaved () {
        ...
        $(("android.widget.TextView")).shouldHave(text("—охранЄнные"));
    }

    public void transitionSearch () {
        $(id("org.wikipedia.alpha:id/nav_tab_search")).click();
        $(("android.widget.TextView")).shouldHave(text("Ќайти"));
        $(id("org.wikipedia.alpha:id/search_card")).shouldBe(visible);
        $(id("org.wikipedia.alpha:id/history_title")).shouldHave(text("»стори€"));
    }

    public void transitionEdits () {
        $(id("org.wikipedia.alpha:id/nav_tab_edits")).click();
        $(("android.widget.TextView")).shouldHave(text("ѕравки"));
        $(id("org.wikipedia.alpha:id/messageTitleView")).shouldHave(text("«наете ли вы, что каждый может редактировать ¬икипедию?"));
    }
    ...
    public void clickSaveButton () { // нажимаем кнопку —охранить
    ...
    public void listNewShouldHaveNameAndDescription () { // провер€ем им€ и описание созданного списка
    ...
    public void listOldShouldHaveNameAndDescription () { // провер€ем им€ и описание списка после изменений
    ...
    public void transitionUserList () { // переход в пользовательский список
        $(xpath("//androidx.recyclerview.widget.RecyclerView[@resource-id=\"org.wikipedia.alpha:id/recycler_view\"]/android.view.ViewGroup[2]")).click(); // проваливаемс€ в список
    }
    ...
    public void refusingSynchronizeLists () { // отказываемс€ от синхронизации списков
        $(id("android:id/button2")).click();
    }

    public void shouldNotSavedLists () { // провер€ем отсутствие сохраненных списков
